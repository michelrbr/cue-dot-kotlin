...
import br.com.mxel.cuedot.domain.IError.Companion.GENERIC_ERROR
...
enum class RemoteError: IError {
    ...
    companion object {
        fun fromErrorApi(error: ErrorApi?): IError {
            if (error == null) {
            ...
            return when (error.statusCode) {
                ...
                10 -> SUSPENDED_API_KEY
                25 -> REQUEST_COUNT_EXCEEDED
                33 -> INVALID_REQUEST_TOKEN
                34 -> RESOURCE_NOT_FOUND
                else -> GENERIC_ERROR
            }
        }
    }
